...
\begin{example}
Data were collected on 54,000 certified diamonds sold in the United
States during the year of 2008. Data were collected by taking
information from sales records in order to study the relationship between
the ``4 Cs'' of diamonds and their prices.
